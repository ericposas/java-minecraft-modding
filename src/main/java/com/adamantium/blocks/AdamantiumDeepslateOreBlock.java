...
public class AdamantiumDeepslateOreBlock extends Block {
    ...
    public static final Identifier identifier = new Identifier(AdamantiumMod.MOD_ID, "adamantium_deepslate_ore");
    ...
    public static final AdamantiumDeepslateOreBlock ADAMANTIUM_DEEPSLATE_ORE = Registry.register(Registries.BLOCK,
            identifier,
